...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalCannotAttend() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. C is optional. 
    //           |--------------C--------------|
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
    ...
    @Test
    public void everyAttendeeIsConsideredOptionalCanAttend() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. C is optional. 
    //                       |--C--|
    // Events  :       |--A--|     |--B--|
